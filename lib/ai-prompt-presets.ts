export const AI_PROMPT_PRESETS = [
  {
    ...
    description: 'A lived-in field note about something that happened in the building.',
    instructions:
  ...
  },
  {
    ...
    description: 'A practical communication post from a superintendent perspective.',
    instructions:
  ...
  },
  {
    ...
    description: 'A diagnosis/process post about equipment, building systems, or repairs.',
    instructions:
  ...
  },
  {
    ...
    description: 'A more reflective post about work pressure, judgment, routines, or lessons.',
    instructions:
...
export const DEFAULT_AI_PROMPT_PRESET_ID: AiPromptPresetId = 'building-operations-story'
...
export function getAiPromptPreset(value: string | undefined) {
  const id = value && isAiPromptPresetId(value) ? value : DEFAULT_AI_PROMPT_PRESET_ID
...
export function applyAiPromptPresetToContext(
  ...
  return trimmedContext ? `${presetContext}\n\nAdditional context:\n${trimmedContext}` : presetContext
}
