...
function post(overrides: Partial<Post> = {}): Post {
  return {
    ...
    excerpt:
      overrides.excerpt ??
      "What a Friday pump alarm taught me about timing, calm, and building operations.",
    content:
      overrides.content ??
    ...
    featuredImageAlt:
      overrides.featuredImageAlt ??
      "Sump pump equipment in a building mechanical room",
