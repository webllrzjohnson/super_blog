...
const prompt = `${topic}. Typical government-subsidized Downtown Toronto apartment building and townhouse setting. Never show the CN Tower. No speech bubbles. No text. No watermarks. No logos. 
